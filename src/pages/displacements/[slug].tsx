...
const FCDisplacements: FC<{displacement: Displacement}> = ({displacement: {observacao, checkList, fimDeslocamento,inicioDeslocamento, kmFinal, kmInicial, motivo}}) => {
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  const displacement = await displacementService.getDisplacementById(ctx.params?.slug as string)
